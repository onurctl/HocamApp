...
public class TestKonuSec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_konu_sec);

        dersSP = findViewById(R.id.dersSpinner); //konuSP = findViewById(R.id.konuSpinner);
        dersT = findViewById(R.id.dersText); //konuT = findViewById(R.id.konuText);
        devamB = findViewById(R.id.devamButon2);
        ...
        devamB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),TestEkrani.class);
